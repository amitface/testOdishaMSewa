package com.test.orissa.msewa.costemview;
 ...
 */
public class AutoScrollAdverPager extends ViewPager {
    ...
    public AutoScrollAdverPager(Context paramContext) {
        super(paramContext);
        init();
    }

    public AutoScrollAdverPager(Context paramContext, AttributeSet paramAttributeSet) {
    ...
    private static class MyHandler extends Handler {
        ...
        private final WeakReference<AutoScrollAdverPager> AutoScrollAdverPager;

        public MyHandler(AutoScrollAdverPager AutoScrollAdverPager) {
            this.AutoScrollAdverPager = new WeakReference<AutoScrollAdverPager>(AutoScrollAdverPager);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SCROLL_WHAT:
                    AutoScrollAdverPager pager = this.AutoScrollAdverPager.get();
                    if (pager != null) {
